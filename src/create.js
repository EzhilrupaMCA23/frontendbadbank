...
async function submitHandler(e){
    ...
    if(name !=='' && mail !==''&& pass.length > 8){
      ...
      // if(!userExist){
        ...
        await axios.post('https://server-k676.onrender.com/create',newUser).then(alert("Account created successfully!!!!")); 
    }
    else{
      if(name === '' && mail ===''){
...
// ctx.users=users color:"black",backgroundColor:"#17cf97",height:"60px"

return(<>
        <Card style={{width:"40%",height:"400px",backgroundColor:"#17cf97",padding:"60px",margin:"50px",textalign:"center", left:"390px",border:"solid 5px black"}}>
     <div id='form-div'>
     <Form className="forminline" onSubmit={submitHandler}>
